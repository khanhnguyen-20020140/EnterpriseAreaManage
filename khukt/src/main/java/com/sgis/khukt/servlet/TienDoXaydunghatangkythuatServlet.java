...
public class TienDoXaydunghatangkythuatServlet extends HttpServlet {
    // SQL CONNECT
    ...
    public Map<String,List<List<String>>> getDataTienDoXaydungHatang(String type_select, String id_select) throws SQLException {
        ...
        String url = "http://"+hostname+":"+port+ "/tiendoXDHTChitiet/tiendoXDHTChitietbyIdduan/"+id_select+"/"+beginDate+"/"+endDate;
    ...
    protected void addTableHeader( String type_select, String selectedName, String title,
        ...
        try {
            ...
            if(type_select.equals(khukinhte)){
                label_content = "TIẾN ĐỘ THỰC HIỆN CÁC DỰ ÁN ĐẦU TƯ XÂY DỰNG HẠ TẦNG KỸ THUẬT TẠI " +selectedName.toUpperCase();
            ...
            if(type_select.equals(duan)){
                label_content = "TIẾN ĐỘ THỰC HIỆN CÁC DỰ ÁN ĐẦU TƯ XÂY DỰNG HẠ TẦNG KỸ THUẬT CỦA " +selectedName.toUpperCase();
            }


            if(type_select.equals(toantinh)){
                label_content = "TIẾN ĐỘ THỰC HIỆN CÁC DỰ ÁN ĐẦU TƯ XÂY DỰNG HẠ TẦNG KỸ THUẬT TẠI CÁC KHU KINH TẾ TỈNH NGHỆ AN";
            }
...
//            v.setAlignReport("justify", designHandle);
            ...
            if(type_select.equals(khuchuyennganh)){
                 url = "http://"+hostname+":"+port+ "/tiendoXDHTChitiet/getIdduanhatangByKCN/"+id_select+"/"+beginDate+"/"+endDate;
            }

            if(type_select.equals(khukinhte)){
                url = "http://"+hostname+":"+port+ "/tiendoXDHTChitiet/getIdduanhatangByKKT/"+id_select+"/"+beginDate+"/"+endDate;
            }

            if(type_select.equals(duan)){
                url = "http://"+hostname+":"+port+ "/tiendoXDHTChitiet/getIdduanhatangByDuan/"+id_select+"/"+beginDate+"/"+endDate;
            }

            if(type_select.equals(toantinh)){
                url = "http://"+hostname+":"+port+ "/tiendoXDHTChitiet/getIdduanhatangAll/"+beginDate+"/"+endDate;
            }
...
//                addTypeselect(,v,designHandle);
                ...
                url = "http://"+hostname+":"+port+ "/tiendoXDHTChitiet/tiendoXDHTChitietbyIdduan/"+myListID.get(t);
