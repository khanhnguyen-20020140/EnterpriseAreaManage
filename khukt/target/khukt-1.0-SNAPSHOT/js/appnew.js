(function ($) {
    ...
    var getUrl = function (storename, layername, epsg) {
        return "http://localhost:8080/geoserver/gwc/service/wmts?" +
    ...
    var getSourceFill = function (nameid, type, storename, layername, epsg, color, opacity) {
        var t = {
            "id": nameid,
            "type": type,
            "source": {
                "type": "vector",
                "tiles": [
                    getUrl(storename, layername, epsg)
                ]
            },
    ...
    var bandofill_nghean = [
        getSourceFill("nghean_tinh", "fill", "khukt", "fill_tinh", 900913, "red", 1, 5),
        getSourceFill("nghean_huyen", "fill", "khukt", "fill_huyen", 900913, "yellow", 1, 4),
        getSourceFill("nghean_xa", "fill", "khukt", "fill_xa", 900913, "#55ff00", 0.8, 3)
    ];

    var getSourceLine = function (nameid, type, storename, layername, epsg, style) {
        var t = {
            "id": nameid,
            "type": type,
            "source": {
    ...
    var bandoline_nghean = [
        getSourceLine("line_huyen", "line", "khukt", "line_huyen", 900913, {'line-color': 'purple','line-width': 2,'line-dasharray':[8, 3]}),
        getSourceLine("line_xa", "line", "khukt", "line_xa", 900913, {'line-color': 'purple','line-width': 0.5,'line-dasharray':[8, 3]})
    ];
    ...
    setTimeout(function () {
        ...
        map = new maplibregl.Map({
            ...
            style: 'http://localhost:8080/khukt/style/basic.json', // style URL
            center: [105.64, 18.72], // starting position
            zoom: 12 // starting zoom
        });

        map.on("load", function () {
            map.addLayer(bandoline_nghean[0], 'building');
            map.addLayer(bandoline_nghean[1], 'line_huyen');
        });
